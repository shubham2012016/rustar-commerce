...
export default function CategoryCard({ product }: CategoryCardProps) {
  const image =
    ...
    "/products/car_bike_shampoo.webp"
    ...
    >
      ...
      <div className="relative flex h-[250px] items-center justify-center overflow-hidden lg:h-[260px]">
        ...
        <Image
          ...
          className="relative z-10 h-[220px] w-auto object-contain drop-shadow-[0_28px_35px_rgba(15,23,42,0.18)] transition-all duration-500 group-hover:-translate-y-2 group-hover:scale-110 lg:h-[240px]"
        />
      </div>

      {/* Content */}
      <div className="relative z-10 px-7 pb-6">
        <div className="my-2 mb-3 inline-flex rounded-full border border-blue-100 bg-blue-50 px-3 py-1 text-xs font-semibold tracking-[0.18em] text-blue-700 uppercase">
          Featured Product
        </div>
        ...
        <p className="mt-3 line-clamp-2 text-[15px] leading-6 text-slate-600">
          {product.subtitle || "Explore our premium automotive care products."}
        </p>
