...
export const PRODUCT: Product = {
  ...
  features: [
    {
      ...
      description:
        "Provides smooth lubrication even during long rides.",
      icon: "Shield",
    },
    {
      id: "2",
      ...
      description:
        "Creates a protective layer against moisture and corrosion.",
      icon: "Droplets",
    },
    {
      id: "3",
      ...
      description:
        "Reduces dirt build-up for cleaner chain performance.",
      icon: "Wind",
    },
    {
      id: "4",
      ...
      description:
        "Performs consistently even in extreme riding conditions.",
      icon: "Flame",
    },
  ],
  ...
  reviews: [
    ...
    },
    {
      ...
      title: "Good Product",
      review:
        "Smooth shifting and quieter chain after using it.",
      verified: true,
